...
<head>
	...
	<title>Car Wash Portal | Admin Dashboard</title>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from tblpackage ";
$query1 = $dbh -> prepare($sql1);;
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalpackage=$query1->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalpackage);?></div>
													<div class="stat-panel-title text-uppercase">Listed Packages</div>
												</div>
											</div>
											<a href="manage-packages.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT id from tblpayments ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Payments</div>
												</div>
											</div>
											<a href="manage-payments.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
