	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="manage-packages.php"><i class="fa fa-files-o"></i> Manage Packages</a></li>
			
			    <li><a href="manage-bookings.php"><i class="fa fa-users"></i> Manage Booking</a></li>

                <li><a href="manage-Work-order.php"><i class="fa fa-sitemap"></i> Manage Work Order</a></li>

                <li><a href="manage-technician.php"><i class="fa fa-street-view"></i> Manage Technicians</a></li>
